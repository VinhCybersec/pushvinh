      ...
      <aside className={`sider-navbar ${width <= 1225 && !isToggle ? "navbar-left-actice" : width <= 1225 && isToggle && "navbar-exanded-active"} `}>
         ...
         <div className="sider_menu sider_menu-c">
            <ul className="sider_menu-list">
               ...
               <NavLink to="/" className={({ isActive }) => isActive ? "sider_menu-item sider_menu-item-acitve sider_active" : "sider_menu-item sider_menu-item-acitve "} title="Khám phá">
                  <div>
               ...
               <NavLink to="/zing-chart" className={({ isActive }) => isActive ? "sider_menu-item sider_menu-item-acitve sider_active" : "sider_menu-item sider_menu-item-acitve "} title="#topchart">
               ...
               <NavLink to="/radio" className={({ isActive }) => isActive ? "sider_menu-item sider_menu-item-acitve sider_active" : "sider_menu-item sider_menu-item-acitve "} title="Radio">
                  <div className="cursor-pointer">
               ...
               <NavLink to="/newfeed/Viet-Nam/IWZ9Z08I" className={({ isActive }) => isActive ? "sider_menu-item sider_menu-item-acitve sider_active" : "sider_menu-item sider_menu-item-acitve "} title="Theo Dõi">
                  <div className="cursor-pointer">
         ...
         <div className="sider_menu sider_menu-bottom">
            <ul className="sider_menu-list">
               ...
               <NavLink to="mv/IWZ9Z08I" className={({ isActive }) => isActive ? "sider_menu-item sider_menu-item-acitve sider_active" : "sider_menu-item sider_menu-item-acitve "} title="MV">
                  <div className="cursor-pointer">
